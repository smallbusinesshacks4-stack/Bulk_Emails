...
const SUBJECT_TEMPLATE =
  "Congratulations {{First Name}}, You're In! Welcome to the AI Engineering Boot Camp";

const BODY_TEMPLATE = `
Hi {{First Name}},

Thanks for signing up with us. Our product is best and we happy to give you 30% discount.
